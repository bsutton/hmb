...
void main() {
  ...
  group('Booking Fee - Time and Materials', () {
    test(r'Time and Materials - Job with zero Booking Fee, $100 System Fee',
        () async {
    ...
    test(r'Time and Materials - Job with null Booking Fee, $100 System Fee',
        () async {
      final now = DateTime.now();
      final job = await createJob(now, BillingType.timeAndMaterial,
    ...
    test(r'Time and Materials - Job with $50 Booking Fee, $100 System Fee',
        () async {
      final now = DateTime.now();
      final job = await createJob(now, BillingType.timeAndMaterial,
    ...
    test('Time and Materials - Job with null Booking Fee, null System Fee',
        () async {
      final now = DateTime.now();
      final job = await createJob(now, BillingType.timeAndMaterial,
          hourlyRate: MoneyEx.fromInt(5000));
