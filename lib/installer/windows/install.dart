...
void windowsInstalller() {
  ...
  if (result == ERROR_SUCCESS) {
    ...
    RegCreateKeyEx(hKey.value, defaultIconKey, 0, nullptr, 0, KEY_WRITE,
        nullptr, hDefaultIconKey, nullptr);
    RegSetValueEx(
    ...
    RegCreateKeyEx(hKey.value, commandKey, 0, nullptr, 0, KEY_WRITE, nullptr,
        hCommandKey, nullptr);
    RegSetValueEx(
        hCommandKey.value,
        nullptr,
