...
class _HMBDateTimeFieldState extends State<HMBDateTimeField> {
  ...
  Widget build(BuildContext context) {
    // Avoid LayoutBuilder here because this widget is often rendered inside
    // AlertDialog, which measures intrinsic dimensions.
    final availableWidth = MediaQuery.sizeOf(context).width;
    final narrow = availableWidth < 480.0;
    ...
    // Wide screens: keep the original row layout.
    return HMBRow(
