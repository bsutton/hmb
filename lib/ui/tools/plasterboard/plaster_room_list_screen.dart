...
class PlasterRoomListScreen extends StatelessWidget {
  ...
  const PlasterRoomListScreen({required this.parent, super.key});

  @override
  Widget build(BuildContext context) =>
      NestedEntityListScreen<PlasterRoom, PlasterProject>(
        parent: parent,
        parentTitle: 'project',
                ...
                await Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (_) => BlockingUITransition<Widget>(
                      ...
                      builder: (context, screen) => screen ?? const HMBEmpty(),
                    ),
                  ),
                );
              }
                ...
                builder: (context, constraints) {
                  ...
                  final summary = DefaultTextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Ceiling Height: $ceilingHeightLabel'),
...
class _RoomPreviewData {
  ...
  const _RoomPreviewData({required this.lines, required this.openings});
}
