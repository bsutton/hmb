...
class StorageWizardStep extends WizardStep {
  final stateKey = GlobalKey<SystemStorageScreenState>();

  StorageWizardStep() : super(title: 'Storage');
  ...
  Widget build(BuildContext context) =>
      SystemStorageScreen(key: stateKey, showButtons: false);
}
